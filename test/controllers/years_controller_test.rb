...
class YearsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create year" do
    assert_difference("Year.count") do
      post years_url, params: { year: { user_id: @year.user_id, year_number: @year.year_number } }
    end
  ...
  test "should update year" do
    patch year_url(@year), params: { year: { user_id: @year.user_id, year_number: @year.year_number } }
